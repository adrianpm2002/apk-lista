                ...
                return (
                  <View style={{ flexDirection:'row', flexWrap:'wrap', justifyContent:'space-between', marginHorizontal:8, marginTop:16 }}>
                    <View style={{ flexBasis:'24%', backgroundColor: '#fff', borderRadius:12, padding:12, marginVertical:6 }}>
                      <Text style={{ color: '#6c757d', fontSize: 12 }}>{getSantiagoHeader('Ventas')}</Text>
                      <Text style={{ fontSize:16, fontWeight:'800', color:'#27AE60' }}>{formatSantiagoMoney(totalBruto)}</Text>
                    </View>
                    <View style={{ flexBasis:'24%', backgroundColor: '#fff', borderRadius:12, padding:12, marginVertical:6 }}>
                      <Text style={{ color: '#6c757d', fontSize: 12 }}>{getSantiagoHeader('Comisión')}</Text>
                    ...
                    <View style={{ flexBasis:'24%', backgroundColor: '#fff', borderRadius:12, padding:12, marginVertical:6 }}>
                      ...
                      <Text style={{ fontSize:16, fontWeight:'800', color: getSantiagoValue(totalBalanceListero)>=0? '#27AE60':'#e74c3c' }}>{formatSantiagoMoney(totalBalanceListero)}</Text>
                    </View>
                  </View>
                );
              })()}
